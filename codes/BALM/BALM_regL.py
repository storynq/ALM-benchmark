...
train_df = pd.read_csv("/home/hongnanqi/ALM_Benchmark/datasets/VL/VL_train.csv")
val_df = pd.read_csv("/home/hongnanqi/ALM_Benchmark/datasets/VL/VL_val.csv")
test_df = pd.read_csv("/home/hongnanqi/ALM_Benchmark/datasets/VL/VL_test.csv")

datasets = DatasetDict({
    "train": Dataset.from_pandas(train_df[['light', 'affinity']]),
    "validation": Dataset.from_pandas(val_df[['light', 'affinity']]),
